...
Nova.booting(function (Vue) {
    Vue.component('index-marshmallow-nova-tags-field', __webpack_require__(3));
    Vue.component('detail-marshmallow-nova-tags-field', __webpack_require__(6));
    Vue.component('form-marshmallow-nova-tags-field', __webpack_require__(9));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        getSuggested: function getSuggested() {
            ...
            window.axios.get('/nova-vendor/marshmallow/marshmallow-nova-tags-field' + queryString).then(function (response) {
                    ...
                    _vm._b(
                      {
                        ...
                        attrs: { placeholder: _vm.__("Add tag...") }
                      },
                      "input",
                      inputProps,
                      false
